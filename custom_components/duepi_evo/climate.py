...
async def async_setup_platform(
    ...
    try:
        ...
        if result_type == "create_entry":
            _LOGGER.info("Imported YAML config for %s into config entries", import_data[CONF_HOST])
            return
...
class DuepiEvoClimateEntity(CoordinatorEntity[DuepiEvoCoordinator], ClimateEntity):
    ...
    async def async_set_fan_mode(self, fan_mode: str) -> None:
        ...
        try:
            await self.hass.async_add_executor_job(self.coordinator.client.set_fan_mode, fan_mode)
    ...
    async def async_set_temperature(self, **kwargs: Any) -> None:
        ...
        try:
            ...
            _LOGGER.error("%s: Unable to set target temp to %s (%s)", self._name, target_temperature, err)
            return
    ...
    async def async_set_hvac_mode(self, hvac_mode: HVACMode) -> None:
        ...
        try:
            await self.hass.async_add_executor_job(self.coordinator.client.set_hvac_mode, hvac_mode)
        except DuepiEvoClientError as err:
